...
def main():
    src = cv2.imread('images/case5/img5_6.png', cv2.IMREAD_COLOR)
    ...
    img_bin = cv2.adaptiveThreshold(gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 51, 5)  # 적응형 이진화
    # morphologyEx
